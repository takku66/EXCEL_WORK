Attribute VB_Name = "TimeChartSheet"
Option Explicit

'*****************************************************************
'ライン作成を関数化（予定ライン）
'*****************************************************************
Function MAKETIMECHARTLINE_SCHEDULED(startTerm As Range, endTerm As Range)
...
'ライン作成を関数化（実績ライン）
'*****************************************************************
Function MAKETIMECHARTLINE_RESULT(startTerm As Range, endTerm As Range, resultRate As Long, planedRate As Long)
...
'ライン作成を関数化（予定進捗）
'*****************************************************************
Function MAKETIMECHARTLINE_SCHEDULED_STATUS(startTerm As Range, endTerm As Range, planedRate As Long)
